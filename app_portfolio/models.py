...
class Tecnologia(models.Model):
    ...
    ordem = models.PositiveIntegerField(default=0, help_text="Quanto menor o número, primeiro ele aparece")
...
class CategoriaProjeto(models.Model):
    ...
    slug = models.SlugField(unique=True, help_text="Nome usado no filtro (ex: web, api, mobile)")
...
class Projeto(models.Model):
    ...
    categoria_projeto = models.ForeignKey(CategoriaProjeto, on_delete=models.SET_NULL, null=True, blank=True, related_name='projetos')
    titulo = models.CharField(max_length=200)
    descricao = models.TextField(help_text="Mantenha por volta de 170 caracteres para simetria")
...
class Perfil(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        impactando positivamente na pontuação de performance do site.
        """
...
class Estatistica(models.Model):
    ...
    legenda = models.TextField(max_length=100, help_text="Dê um 'Enter' onde deseja quebrar a linha")
    ordem = models.PositiveIntegerField(default=0, help_text="Define a posição de exibição")
    destaque_sobre = models.BooleanField(default=False, verbose_name="Destaque na foto Sobre Mim")
...
class CategoriaHabilidade(models.Model):
    ...
    nome = models.CharField(max_length=50)
    icone = models.CharField(max_length=50, help_text="Nome da classe ou arquivo do ícone", blank=True)
...
class Habilidade(models.Model):
    ...
    categoria = models.ForeignKey(CategoriaHabilidade, on_delete=models.CASCADE, related_name='habilidades')
    nome = models.CharField(max_length=50)
...
class MensagemContato(models.Model):
    ...
    data_envio = models.DateTimeField(auto_now_add=True) # Data gerada automaticamente no envio
